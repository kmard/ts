...
Процедура ВключениеТехнологическогоЖурнала(ПараметрыТехнологическогоЖурнала, РезультатВключения) Экспорт
	...
	Если КаталогКонфигурацииПриложения <> Неопределено Тогда 
		...
		Текст = "<?xml version=""1.0"" encoding=""UTF-8""?>" + Символы.ПС + "<!-- ConsoleQueries -->" + Символы.ПС
			+ "<config xmlns=""http://v8.1c.ru/v8/tech-log"">" + Символы.ПС + "<dump create=""false"" type=""0"" prntscrn=""false""/>"
			+ Символы.ПС + "<log history=""1"" location=""" + КаталогСЛогФайлами + """>" + Символы.ПС;
		...
		Текст = Текст + "<property name=""all""/>" + Символы.ПС+ "  <property name=""sql""/>" + Символы.ПС
			+ "  <property name=""plansqltext""/>" + Символы.ПС + "</log>" + Символы.ПС + "<plansql/>" + Символы.ПС + "</config>";
...
Функция СведенияОВнешнейОбработке() Экспорт
    ...
    ПараметрыРегистрации.Вставить("Информация", "Консоль запросов");
